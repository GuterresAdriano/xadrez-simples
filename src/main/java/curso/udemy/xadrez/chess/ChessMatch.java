...
public class ChessMatch {
	...
	private void initializeGame() {
		...
		//		placeNewPiece('g', 8,new Horse (this.board,Color.BLACK));
		...
		//		placeNewPiece('b', 8,new Horse (this.board,Color.BLACK));
		...
		//		placeNewPiece('g', 1,new Horse (this.board,Color.WHITE));
		...
		//		placeNewPiece('b', 1,new Horse (this.board,Color.WHITE));
